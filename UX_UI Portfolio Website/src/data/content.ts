export const contentData = {
	...
	caseStudies: [
					...
					annotations: [
						{
							number: 1,
							description:
								"Card layout groups related info visually — easier scanning than tables on mobile",
						},
						{
							number: 2,
							description:
								"Action buttons (Devolución, Imprimir QR) accessible without navigating into a menu",
						},
						{
							number: 3,
							description:
					...
					annotations: [
						{
							number: 1,
							description:
								"Destructive action requires explicit confirmation — prevents costly operational mistakes",
						},
						{
							number: 2,
							description:
								"Order details repeated in modal to ensure user has full context",
						},
						{
							number: 3,
							description:
				...
				},
				{
					...
					annotations: [
						...
						},
						{
							number: 2,
							description:
								"Template download ensures data format compliance before upload",
						},
						{
							number: 3,
							description:
...

		{
			...
			details: {
				...
				keyDecisions: [
					{
						title:
							"Gamification as an equity solution, not just an engagement feature",
						description:
			...
			heroCarousel: [
				{
					...
					annotations: [
						...
						},
						{
							number: 3,
							description:
								"XP system provides clear progression metric across all contribution types",
						},
						{
							number: 4,
							description:
				...
				},
				{
					...
					annotations: [
						...
						},
						{
							number: 2,
							description:
								"Highlighted user row creates immediate personal connection to the data",
						},
						{
							number: 3,
							description:
								"Sidebar navigation provides clear context switching between sections",
						},
					],
				},
				{
					...
					annotations: [
						...
						},
						{
							number: 2,
							description:
								"Group tutoring sessions surfaced prominently — previously invisible in the system",
						},
						{
							number: 3,
							description:
								"Carousel pattern allows content discovery without overwhelming the home view",
						},
					],
				},
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Achievement showcase with progress indicators maintains motivation over time",
						},
						{
							number: 2,
							description:
								"Virtual currency system adds a gamification layer beyond simple point tracking",
						},
						{
							number: 3,
							description:
...

		{
			...
			details: {
				...
				impact: [
					...
					{
						metric: "AI",
						label: "Conversational UI for natural language queries",
					},
					{ metric: "Real-time", label: "Network capacity monitoring" },
					{
						metric: "2 profiles",
						label: "Technical and executive users served",
					},
				],
				retrospective:
			...
			heroCarousel: [
				{
					...
					annotations: [
						...
						},
						{
							number: 4,
							description:
								"Progressive disclosure: time-series data shows trends without overwhelming",
						},
					],
				},
				{
					...
					annotations: [
						...
						},
						{
							number: 3,
							description:
								"Critical alerts front and center — multiple instances signal a systemic issue",
						},
						{
							number: 4,
							description:
								"Dual-axis chart comparing usage vs. capacity for planning decisions",
						},
					],
				},
				{
...

		{
			...
			description:
				"AI-enhanced booking platform designed across 3 user roles and 4 surfaces — including a physical space videowall with real-time reservation display",
			...
			details: {
				...
				problem:
					"The DREAM Lab innovation space had no booking system — scheduling was manual, resources were underutilized, and new users faced a steep learning curve just to reserve a space. The lab didn't exist yet, which meant we couldn't measure current behavior; we had to design for anticipated friction, then validate it. That constraint shaped everything: research had to be generative, assumptions had to be stress-tested, and the system had to feel credible enough that students would actually want to use it before the space even opened.",
				discovery:
					"We interviewed students to understand how they'd want to book and manage a lab space — asking about their habits with existing scheduling tools and what they'd need to feel confident using something new. Two themes came up consistently: clarity and fairness. Students wanted to know exactly what they were booking and feel like the system wasn't arbitrary about who got access — which directly drove the points-based prioritization model. They also wanted something that felt modern and worth using. Because the lab didn't exist yet, research was generative rather than observational. We stress-tested assumptions through two rounds of usability testing — once on the prototype, once on the implemented system — and the findings shaped the final design: the Netflix-style area browsing, large touch targets, and the booking summary before confirmation all came directly from observed friction in testing.",
				users: [
					{
						role: "Students",
						description:
							"Primary users booking spaces and equipment. Needed a fast, guided experience with clear availability and a fair access model — especially for first-time bookings.",
					},
					{
						role: "Professors",
						description:
				...
				insights: [
					"Students wanted clarity above all — knowing exactly what they were reserving before committing",
					"Fairness in access was a recurring concern — arbitrary-feeling systems created distrust before users even started",
					"Modern, visually engaging interfaces increased perceived credibility and willingness to engage with a new tool",
					"Usability testing surfaced specific wins: Netflix-style browsing, large touch targets, and a pre-confirmation summary all reduced observed hesitation",
				],
				constraints: [
					"Three distinct user roles with different needs in the same system",
					"Lab space didn't exist yet — research had to be generative, not observational",
					"Integration with planned lab equipment inventory",
					"Full implementation required — not a prototype, a shipped product across 4 surfaces including a physical space videowall",
				],
				process: [
					{
						title: "User Research & Generative Interviews",
						description:
							"Interviewed students to surface booking habits, expectations, and concerns — with a focus on fairness and clarity as the two dominant themes that shaped core system decisions",
					},
					{
						title: "UX & Information Architecture",
						description:
							"Redesigned the booking flow to surface equipment availability earlier, reduce steps, and provide clear progress signals throughout — including a pre-confirmation summary that directly addressed observed hesitation",
					},
					{
						title: "AI, Voice & Physical Space Integration",
						description:
							"Implemented AI-powered personalized recommendations, a voice assistant for mobile input, and a physical space videowall with student ID scanner — each driven by specific research or testing findings",
					},
					{
						title: "Usability Testing & Iteration",
						description:
							"Two rounds of formal testing — once on the high-fidelity prototype and once on the implemented system — with targeted iterations between rounds based on observed friction points",
					},
				],
				keyDecisions: [
					{
						title: "Points-based prioritization as a fairness mechanism",
						description:
							"The gamification system wasn't decorative — it came directly from student interviews where arbitrary access felt like a dealbreaker. Points tied to real lab behaviors (on-time arrivals, equipment returns, consistent usage) gave the prioritization model a logic students could understand and trust. Competitive visibility was intentional: seeing your standing creates accountability without feeling punitive.",
					},
					{
						title: "Voice assistant as a genuine accessibility feature",
						description:
							"On mobile, typing out a booking request across multiple form fields is slow and error-prone. The voice assistant was a direct response to input fatigue observed during usability testing, particularly for first-time users who weren't sure what fields were required.",
					},
					{
						title: "3D space visualization for context before commitment",
						description:
							"Students were hesitant to commit to a booking for a space they'd never seen. A 3D visualization of the physical space, paired with a calendar-first design, gave users the context they needed without having to visit the lab first — especially relevant given the lab wasn't yet built.",
					},
					{
						title: "Physical videowall as a fourth surface",
						description:
							"The system extended beyond screens. A videowall designed for the physical lab space displayed upcoming reservations and announcements in real time. A student ID scanner at the entrance surfaced reservation details on check-in — and for students without a reservation, generated a QR code for on-the-spot booking. Designed, prototyped, and implemented.",
					},
				],
				solution:
					"A fully implemented booking platform with AI-powered personalized recommendations, voice-activated booking, real-time availability tracking, 3D space visualization, and a points-based prioritization model grounded in student interviews about fairness. The system spans three user roles across 50+ screens and extends into the physical space: a lab videowall displays upcoming reservations and announcements, and includes a student ID scanner that surfaces reservation details on check-in or generates a QR code for on-the-spot booking.",
				impact: [
					{ metric: "50+", label: "Screens designed across 3 user roles" },
					{
						metric: "3",
						label: "User roles — student, professor, and lab administrator",
					},
					{
						metric: "30+",
						label: "Features implemented across the full system",
					},
					{
						metric: "4th surface",
						label:
							"Physical space videowall with ID scanner and real-time reservation display — designed, prototyped, and implemented",
					},
				],
				retrospective:
					"Because the lab wasn't built yet, we couldn't validate against real usage data — which is the honest limitation of this project. We tested twice, which is better than most academic projects manage, but longer-term data would be the next thing to measure: whether the points system sustained engagement over a full semester, whether the fairness framing actually reduced conflict at the admin level, and whether the videowall changed how students interacted with the space on arrival. Those are open questions worth answering once the lab opens.",
			},
			heroCarousel: [
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Points-based prioritization — fairness mechanism grounded in student interviews, not decorative gamification",
						},
						{
							number: 2,
							description:
								"Priority points displayed prominently create accountability and motivation",
						},
						{
							number: 3,
							description: "Upcoming reservations surfaced to reduce no-shows",
						},
						{
							number: 4,
					...
					annotations: [
						{
							number: 1,
							description:
								"3D visualization gives users context about the physical space before committing — especially important for a lab that wasn't yet built",
						},
						{
							number: 2,
							description:
								"Calendar-first design aligns with how students mentally model reservations",
						},
						{
							number: 3,
							description:
								"Capacity information surfaces competitive urgency without creating anxiety",
						},
						{
							number: 4,
							description:
				...
				},
				{
					...
					annotations: [
						...
						},
						{
							number: 2,
							description:
								"Real-time selection summary reduces cognitive load during equipment choice",
						},
						{
							number: 3,
							description: "Clear CTA to move forward — single action per step",
						},
					],
				},
			],
					...
					annotations: [
						{
							number: 1,
							description:
								"Cart as a pop-up keeps users in context — no navigation away from the product page",
						},
						{
							number: 2,
							description:
								"Total visible immediately before entering checkout — reduces hesitation",
						},
						{
							number: 3,
							description: "Quantity adjustments inline, no extra steps",
						},
					],
				},
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Guest checkout is the primary CTA — conversion before account acquisition",
						},
						{
							number: 2,
							description:
								"Login available as secondary option for returning users who want saved details",
						},
						{
							number: 3,
							description:
								"Benefit-led framing: 'Checkout faster' not 'You must log in'",
						},
					],
				},
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Autofill for returning users — minimize typing at the highest cognitive load step",
						},
						{
							number: 2,
							description:
								"Shipping costs visible here, not at review — no surprises",
						},
						{
							number: 3,
							description: "Persistent total at bottom throughout the flow",
						},
					],
				},
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Multiple payment methods with card brand icons — trust signals at the highest anxiety moment",
						},
						{
							number: 2,
							description: "Billing address toggle reduces unnecessary input",
						},
						{
							number: 3,
							description:
								"Add card via modal — keeps checkout context, same pattern as address change",
						},
					],
				},
				{
					...
					annotations: [
						{
							number: 1,
							description:
								"Everything visible before committing — delivery, payment, items, total",
						},
						{
							number: 2,
							description:
								"Edit shortcuts for each section without losing place in flow",
						},
						{
							number: 3,
							description:
								"CTA includes price — 'Place order • $199' — final transparency signal",
						},
					],
				},
			],
