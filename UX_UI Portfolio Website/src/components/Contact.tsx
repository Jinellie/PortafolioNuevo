...
export default function Contact({ theme, prefersReducedMotion, data }: ContactProps) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <div className={`p-8 rounded-2xl ${
              ...
              <h4 className="mb-4 tracking-tight">
        ...
        <motion.div
          ...
          className={`mt-24 pt-8 border-t text-center ${
            theme === 'dark' ? 'border-neutral-800 text-neutral-500' : 'border-neutral-200 text-neutral-500'
          }`}
        >
          <p>© 2024 Jinelle Flores. Designed & built with precision and care.</p>
        </motion.div>
      </div>
    </section>
  );
